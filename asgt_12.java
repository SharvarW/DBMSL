...
Assignment no:12
---------------------------------------------------------------------------------------------  
Create employee array objects containing employee id , name, designation, salary using JSON 
and write a program in python/Java to read and display the employee information.
---------------------------------------------------------------------------------------------
*/
